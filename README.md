...
This is the Customer Website portion of our Internship project. Built with ReactJS, Typescript and Shadcn-UI.
...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/YGOhappy123/NHT_Marine_FEC.git
    ```
